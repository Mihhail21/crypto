...
const Selector = (props) => {
      ...
      if (filterElement.length === 0) {
        filterElement = [
          <option value={null} key={'n'}>Нет</option>
        ]
      }
      ...
      <div className={styles.mainBox}>
            <div className={styles.mainBox__selector}>
              <div className={styles.selector__name}>Отдаёте</div>
              <div className={styles.selector__buttonBox}>
              ...
              <div className={styles.selector__select}>
            ...
            <div className={styles.mainBox__selector}>
              <div className={styles.selector__name}>Получаете</div>
              <div className={styles.selector__buttonBox}>
